...
export function AddText({showList, setAddNewText}) {
  ...
  return (
    <>
    <section onClick={ () => {setAddNewText(false)} } className="absolute w-[100%] h-[100%] bg-[#162238]/50 dark:bg-white/20 shadow-sm">
    </section>
        ...
        <CardContent>
          <form id="AddNewCardText" className="grid gap-4">
              <div className="grid gap-2 mb-2">
                ...
                <textarea className="p-2 rounded-sm border-1 border-gray-500"

...
export function Note(){
    return (
        <div className="w-[20rem] h-auto p-4 rounded-md border-1 border-gray-400">
            ...
            <section className="w-[100%] h-auto flex flex-col items-start justify-center gap-2">
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil eaque nesciunt iusto, voluptas iure corporis quod, repellendus consequuntur repellat fuga, beatae sed voluptatem? Voluptas incidunt, impedit laborum accusantium possimus cupiditate!

            ...
            <div className="mt-4 w-[100%] h-auto grid grid-flow-col grid-rows-3 gap-6 items-start justify-start overflow-x-auto overflow-y-hidden px-[2rem] ">
                {
                    boardList.map((list) => {
                        return (
                            <div key={list.id} style={{ backgroundColor: list.bg }} className={`w-[18rem] h-[8rem] p-4 border-none flex items-center justify-center overflow-hidden rounded-md shadow-md`}>

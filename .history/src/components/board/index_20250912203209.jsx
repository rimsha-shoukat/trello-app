            ...
            <div className="mt-4 w-[100%] h-auto grid grid-flow-col grid-rows-3 gap-6 items-start justify-start overflow-x-auto overflow-y-hidden whitespace-nowrap px-[2rem]">
                {
                    boardList.map((list) => {
                        return (
                            <div key={list.id} style={backgroundColor: list.color} className={`w-[15rem] h-[8rem] p-4 border-none flex flex-col gap-2 items-center justify-center rounded-md shadow-md`}>

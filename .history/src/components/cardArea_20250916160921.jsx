    ...
    return (
        <>
            {cards && Array.isArray(cards) && cards.map((card) => (
                    <section key={card.id} style={{backgroundColor: card.bg}} className="w-[100%] flex flex-row items-start justify-star gap-2 h-auto p-2 border-0 rounded-md shadow-md">
                        <input type="checkbox"/>

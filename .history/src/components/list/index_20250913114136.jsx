        ...
        <>
            <section style={{
                ...
                className="mt-4 w-[100%] h-auto grid grid-flow-col grid-rows-1 gap-8 items-start justify-start overflow-x-auto overflow-y-hidden px-[2rem]">
                {
                    listBox.map((list) => {
                        return (
                            <div key={list.id} style={{ backgroundColor: list.bg }} className={`w-[2rem] h-auto p-4 border-none flex items-center justify-center overflow-hidden rounded-md shadow-md`}>

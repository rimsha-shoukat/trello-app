                    ...
                    <>
                        <div
                            ...
                            <div key={l.id} className="relative w-[20rem] h-auto">
                                <CiEdit style={{ color: l.text }} className="absolute text-[1.5rem] hover:scale-105 cursor-pointer top-4 right-2 transition-opacity duration-300"/>
                                <div key={l.id} style={{ backgroundColor: l.bg }} className={`w-[24rem] h-auto border-none flex flex-col p-4 gap-4 items-center justify-center overflow-hidden rounded-md shadow-md`}>

                ...
                {list && Array.isArray(list) && list.length === 0 ? (
                    ...
                    <>
                        <div
                            ...
                            <div key={l.id} className="relative w-[20rem] h-[12rem]">
                                          <CiEdit style={{ color: board.text }} className="absolute text-[1.2rem] cursor-pointer top-2 right-2 opacity-0 hover:opacity-100 transition-opacity duration-300"/>

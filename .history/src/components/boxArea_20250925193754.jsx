...
export default function BoxArea({ boardList, setBoardList, greeting }) {
  return (
    <section className="select-none text-gray-800 w-[100%] h-auto flex flex-col items-center justify-start bg-gradient-to-br from-slate-50 via-white to-indigo-50 pt-8 pb-12 overflow-hidden">
      <h1 
        className={`
          ${greeting ? 'block opacity-100 translate-y-0' : 'hidden opacity-0 translate-y-4'} 
          font-bold text-[3.5rem] max-[450px]:text-[2rem] text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-500 

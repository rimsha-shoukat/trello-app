          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div>
              ...
              <div className="relative">
                ...
                />
                <div 
                  className="w-full h-12 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 border-2 border-gray-200/50 cursor-pointer bg-gradient-to-r from-gray-00 to-gray-500 flex items-center justify-center"

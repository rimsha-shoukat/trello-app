...
export default function BoxArea({ boardList, setBoardList, greeting }) {
  return (
    <section className="select-none text-gray-800 w-[100%] h-[1 flex flex-col items-center justify-start bg-gradient-to-br from-slate-50 via-white to-indigo-50 pt-8 pb-12 overflow-hidden">
      <h1 
        className={`

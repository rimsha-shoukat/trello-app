        ...
        boardList && Array.isArray(boardList) && boardList.length === 0 ? (
          ...
          <section style={{
            ...
            <div key={board.id} className="relative w-[20rem] h-[12rem]">
              ...
              <MdOutlineDelete style={{ color: board.text }} onClick={() => deleteBoard(board.i)} className="text-[1.5rem] hover:scale-105 cursor-pointer transition-opacity duration-300"/>
              </div>

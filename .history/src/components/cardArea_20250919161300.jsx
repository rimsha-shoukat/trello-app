               ...
               <div key={card.id} className="relative w-[100%]">
                {
                 ...
                 <TbCancel style={{ color: card.text }} onClick={ () => setEditMode(false)} className="hover:scale-105 text-[1.5rem] cursor-pointer transition-opacity duration-300" />
                 <VscSaveAs  style={{ color: card.text }} onClick={ () => editCard(card.id)} className="hover:scale-105 text-[1.5rem] cursor-pointer transition-opacity duration-300"/>
                        ...
                        <div className="absolute top-2 right-2 flex flex-row gap-2">
                 <CiEdit style={{ color: card.text }} onClick={() => handleEditCard(card.id)} className="hover:scale-105 text-[1.5rem] cursor-pointer transition-opacity duration-300"/>

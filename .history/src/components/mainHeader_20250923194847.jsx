...
export default function mainHeader({boardBox, setBoardBox}){
    return(
        <>
            <h1 className="text-transparent bg-clip-text bg-gradient-to-r from-white via-indigo-200 to-purple-300 text-[2.2rem] font-bold cursor-pointer tracking-wide hove">Trello</h1>

...
export default function cardDialogBox({ newCard, setNewCard, list, activeList, boardList={boardList} setBoardList={setBoardList} }) {
    const [description, setDescription] = useState('');
    const [bg, setBg] = useState('#616060');
    const [text, setText] = useState('#f5f2f2');
    const currentList = list.find(l => l.id === activeList) || {};

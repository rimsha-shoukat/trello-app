                    ...
                    <>
                        <div
                            ...
                            <div key={l.id} className="relative w-[20rem] h-auto">
                                ...
                                <div key={l.id} style={{ backgroundColor: l.bg }} className={`w-[] h-auto p-4 border-none flex flex-col gap-4 items-center justify-center overflow-hidden rounded-md shadow-md`}>

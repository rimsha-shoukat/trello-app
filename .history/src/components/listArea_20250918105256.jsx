                    ...
                    <>
                        <div
                            ...
                            <div key={l.id} className="relative w-[20rem] h-auto">
                                <CiEdit style={{ color: l.text }} className="absolute text-[1.5rem] hover:scale-105 pt-2 cursor-pointer top-2 right-2 opacity-100 transition-opacity duration-300"/>

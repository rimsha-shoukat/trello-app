...
export default function boxDialogBox({ boardBox, setBoardBox, boardList, setBoardList }) {
  ...
  return (
    <>
      {/* Backdrop */}
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 fixed inset-0 bg-black/50 backdrop-blur-sm z-20 flex items-center justify-center p-4" onClick={() => setBoardBox(false)}>
        {/* Modal Content */}
        <form 

                    ...
                    <>
                        <div
                            ...
                            <div key={l.id} className="relative w-[20rem] h-auto">
                                <CiEdit style={{ color: l.text }} className="absolute text-[1.5rem] hover:scale-105 cursor-pointer top-2 right-2 transition-opacity duration-300"/>
                                <div key={l.id} style={{ backgroundColor: l.bg }} className={`w-[24re] h-auto p-4 border-none flex flex-col gap-4 items-center justify-center overflow-hidden rounded-md shadow-md`}>

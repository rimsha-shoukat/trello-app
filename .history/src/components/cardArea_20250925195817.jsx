...
export default function cardArea({ cards, board, activeList, boardList, setBoardList }) {
  ...
  return (
    <>
      {cards.map((card) => {
        const cardBg = card.bg || '#7c7c7cff'; 
        const cardText = card.text || '#085196ff'; 
        ...
        return (
          <div key={card.id} className="relative w-full group mb-3">
            ...
            <div className={`
              ...
              transition-all duration-300 opacity-70 group-hover:opacity-100 z-10
            ...
            <section 
              ...
              className={`
                w-full flex items-start justify-start gap-3 h-auto p-2 border-2 border-white/20 rounded-xl shadow-md 

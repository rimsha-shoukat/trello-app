                    ...
                    <>
                        ...
                        <div
                            ...
                            {list && Array.isArray(list) && list.map(l => (
                                <div key={list.id} style={{ backgroundColor: l.bg }} className={`w-[24rem] h-auto p-4 border-none flex flex-col items-center justify-center overflow-hidden rounded-md shadow-md`}>

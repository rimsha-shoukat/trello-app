        ...
        {boardBox && (
          <form onSubmit={handleNewBoard} className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#b32509] p-6 rounded-md shadow-lg">
            <input
              ...
              className="border-2 p-2 rounded-md w-[10rem] border-gray-800/50 focus:outline-none focus:ring-0"
              placeholder="Enter board title" required
            />
            <div className="flex flex-row w-[100%] items-center justify-evenly mt-2">
              <input
              ...
              <input
                ...
                className="p-[0.25rem] cursor-pointer rounded-md w-18 h-10 shadow-sm hover:scale-105"

      ...
      <navbar className="w-[100%] flex flex-row justify-between items-center bg-[#b32509] py-[0.6rem] px-4 shadow-md select-none">
          ...
          </div>
          {
            boardBox && <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#b32509] p-2 rounded-md">
              ...
              <textarea rows="4" className="w-[100%] p-2 rounded-md" placeholder='description (optinal...)'/>
              <div className="w-[100%] mt-4 flex flex-row justify-between items-center">
                <button onClick={} className="px-4 py-2 bg-gray-400/60 hover:bg-gray-400/40 rounded-md cursor-pointer font-semibold">cancel</button>

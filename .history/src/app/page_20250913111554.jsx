...
export default function Home() {
  ...
  const [bg, setBg] = useState("#6160");
  const [text, setText] = useState('#f5f2');
  ...
  return (
    <>
      <navba className="w-[100%] flex flex-row justify-between items-center bg-[#b32509] py-[0.6rem] px-4 shadow-md select-none">

      ...
      <section className="w-[100%] flex flex-row justify-between items-center bg-[#D6B588] py-[0.6rem] px-4 shadow-md select-none">
        ...
        <div className="flex flex-row gap-4">
          <button
            ...
            className="py-2 px-4 bg-[#D6B588] hover:shadow-sm hover:scale-105 hover:shadow-gray- rounded-md cursor-pointer font-semibold text-white shadow-md transition-all duration-300"
          >
            + Board
          </button>
        </div>

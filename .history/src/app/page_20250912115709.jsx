  ...
  return (
    <>
      <navbar className="w-[100%] flex flex-row justify-between items-center bg-[#b32509] py-[0.6rem] px-4 shadow-md select-none">
        ...
        {boardBox && (
          <form action="/Board" className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#b32509] p-6 rounded-md shadow-lg">
            <div className="flex flex-row items-center justify-between gap-2">
              ...
              <input
                type="color"
                className="p-[0.25r] cursor-pointer rounded-md w-10 h-10 shadow-sm hover:scale-105"
                title="Pick a color"
              />
            </div>
            <textarea

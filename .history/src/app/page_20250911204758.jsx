...
export default function Home() {
  ...
  const [newBoard, setNewBoard] = useState(fal);
  ...
  return (
    <>
      <navbar className="w-[100%] flex flex-row justify-between items-center bg-[#b32509] py-[0.6rem] px-4 shadow-md select-none">
        ...
        <button onClick={() => setNewBoard(!newBoard)} className="py-2 px-4 bg-gray-400/60 hover:bg-gray-400/40 rounded-md cursor-pointer font-semibold">+ Board</button>
        {

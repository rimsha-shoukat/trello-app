          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#b32509] p-6 rounded-md shadow-lg">
            ...
            <div className="w-[100%] mt-4 flex flex-row justify-between items-center">
              <button
                ...
                className="px-4 py-[0.35rem] bg-[#b32509] hover:shadow-sm hover:scale- hover:shadow-gray-300 rounded-md cursor-pointer font-semibold shadow-sm transition-all duration-300"
              >
                Cancel
              </button>
              <button

        ...
        {boardBox && (
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#b32509] p-6 rounded-md shadow-lg">
            <div className="flex flex-row items-center justify-between gap-2">
              <input
                type="text"
                className="border-2 p-2 rounded-md w-[14rem] border-gray-800/50 focus:outline-none focus:ring-2 focus:ring-gray-800"
                placeholder="Enter board title"
              />
              <input
                type="color"
                className="cursor-pointer rounded-md w-10 h-10 shadow-sm hover:scale-105"
                title="Pick a color"
              />
            </div>
            <textarea
              rows="3"
              className="mt-2 w-[100%] p-2 rounded-md border-2 border-gray-800/50 focus:outline-none focus:ring-2 focus:ring-gray-800"

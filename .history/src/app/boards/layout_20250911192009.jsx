...
export default function BoardsLayout({ children }){
    const[dropdown, setDropdown] = useState(showBox);
    ...
    return (
        ...
        <navbar className="w-[100%] flex flex-row justify-between items-center bg-[#b32509] p-[0.6rem] shadow-md select-none">
         ...
         <div className="flex flex-row gap-4">
            <button onClick= {() => detDropdown(!dropdown)} className="text-white py-2 px-4 bg-gray-400/60 hover:bg-gray-400/40 rounded-md cursor-pointer font-semibold">Boards</button>

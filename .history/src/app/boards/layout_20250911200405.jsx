...
export default function BoardsLayout({ children }){
    ...
    return (
        ...
        <navbar className="w-[100%] flex flex-row justify-between items-center bg-[#b32509] py-[0.6rem] px-4 shadow-md select-none">
         ...
         {   
            dropdown && <div className="absolute w-[10] top-[4.5rem] right-[6rem] transition-all ease-in-out duration-6 delay-[0.3s] bg-[#b32509] p-2 rounded-md">
            ...
            <button className="p-2 bg-gray-400/60 w-[100%] hover:bg-gray-400/40 rounded-md cursor-pointer font-semibold">+ Board</button>
            </div>
        }
        </navbar>

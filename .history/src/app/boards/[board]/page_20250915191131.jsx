...
export default function Boards() {
  ...
  cons currentList = null;
  if(card){
    currentList = card.find(c => c.id === activeList);
  }
  ...
  return (
    <>
      <section className="w-[100%] flex flex-row justify-between items-center bg-[#b32509] py-[0.6rem] px-4 shadow-md select-none">
        ...
        <ListDialogBox listBox={listBox} setListBox={setListBox} boardId={boardId} />
        <CardDialogBox newCard={newCard} setNewCard={setNewCard} list={list} currentList={currentList} />
      </section>

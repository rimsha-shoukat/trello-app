    ...
    <>
      ...
      <section style={{
        ...
        {board.lists && Array.isArray(board.lists) && board.lists.length === 0 ? (
          <h2 className="text-[1.2rem] mt-4 text-[#b32509]">No lists added yet!</h2>
        ) : (
          <>
            <h1 className="text-[2.2rem] mt-4 px-[2rem] text-[#b32509]">{board.title}</h1>
            <div className="mt-4 w-[100%] h-auto grid grid-flow-col grid-rows-1 gap-8 items-start justify-start overflow-x-auto overflow-y-hidden px-[2rem]">

  ...
  return (
    <>
      <section className="w-[100%] flex flex-row justify-between items-center bg-[#b32509] py-[0.6rem] px-4 shadow-md select-none">
        ...
        <CardDialogBox newCard={newCard} setNewCard={setNewCard} list={board.lists} activeList={activeList} boardList={boardList}  />
      </section>
      {list && <ListArea board={board} list={board.lists} newCard={newCard} setNewCard={setNewCard} setActiveList={setActiveList} />}
    </>
  )
}
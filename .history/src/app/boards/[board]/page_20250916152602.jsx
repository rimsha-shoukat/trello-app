...
const currentList = board?.lists?.find(l => l.id == activeList) || {};  const [listBox, setListBox] = useState(false);
  ...
  return (
    <>
      <section className="w-[100%] flex flex-row justify-between items-center bg-[#b32509] py-[0.6rem] px-4 shadow-md select-none">
        ...
        <CardDialogBox newCard={newCard} setNewCard={setNewCard} board={board} activeList={activeList} boardList={boardList}  />
      </section>

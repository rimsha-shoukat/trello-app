    ...
    <>
      <section className="w-[100%] flex flex-row justify-between items-center bg-[#333231] py-[0.6rem] px-4 shadow-md select-none">
        ...
        <div className="flex flex-row gap-4">
          <button onClick={() => setListBox(!listBox)} className="py-2 px-4 hover:shadow-sm hover:scale-105 hover:shadow-gray-300 bg-[#2e1d06] rounded-md cursor-pointer font-semibold">+ List</button>
        </div>
